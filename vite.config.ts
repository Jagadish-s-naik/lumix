...
const SITE_URL = process.env.VITE_SITE_URL ?? "https://lumix-one.vercel.app/";
...
//   standalone-send     one self-contained lumix-sender.html
//   standalone-receive  one self-contained lumix-receiver.html
//
  ...
  if (standalone) {
    return {
      ...
      plugins: [
        ...
        standaloneCsp(page),
        viteSingleFile(),
        emitAs(outDir, `${page}/index.html`, `lumix-${page === "send" ? "sender" : "receiver"}.html`),
      ],
